...
- генерация письма заказчику/поставщику на основе рекомендаций (тема + текст для отправки);
...
### Основные метрики моделей

| Модель | MAE | RMSE | RMSPE | R² |
|---|---:|---:|---:|---:|
| Naive lag_7 | 2033 | 2651 | 0.385 | 0.247 |
| HGB baseline | 652 | 955 | 0.141 | 0.902 |
| Final model | 622 | 906 | 0.142 | 0.912 |
